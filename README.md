...
A Python project implementing fundamental matrix operations and linear algebra algorithms from scratch without external libraries.
...
- Permutation generation and parity checking
